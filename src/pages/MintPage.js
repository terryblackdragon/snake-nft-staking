...
import nftContract from "../artifacts/APE.sol/APE.json";
...
function MintPage() {
    ...
    const mint = async () => {
        console.log("network=", data.network, ':', networksMap[networkDeployedTo], ':',info.paused);
    ...
    return (
        <section className="MINTPage">
                ...
                <div className="roadmap-container"  >
                    ...
                    <div className='info-container'>
                        ...
                        <Table responsive>
                            <tbody>
                                <tr>
                                    <td className='p-2'>Your APE NFTs </td>
                        ...
                        <div className="row" style={{ justifyContent: "center" }}>
                            <div className="col-md-7">
                                <div className="text-center">
                                    ...
                                    {/* <p className="lead" style={{ marginBottom: "30px" }}>A APE is a character that is part of an 10000 algorithmically generated collection consisting of extremely unique features ranging from faces, eyes, mouths, skins, hats, and backgrounds.</p> */}
            ...
            <section className='my-items'>
                {userNfts.length !== 0 ? (
                    <>
                        <h2 className="minttitle title text-center">My APE NFTs</h2>
